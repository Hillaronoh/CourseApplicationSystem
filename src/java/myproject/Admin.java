...
public class Admin {
    ...
    public Admin() throws ClassNotFoundException{
        ...
        try{
            ...
            pst7=conn.prepareStatement("UPDATE inquiries SET Reply=? WHERE Sender=? AND Message=?");
            pst8=conn.prepareStatement("SELECT Message, Reply FROM inquiries WHERE Sender=?");
