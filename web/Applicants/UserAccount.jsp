            ...
            <div class="row" style="margin-left: -58px; margin-top: -20px;">
                ...
                <div class="col-md-4 col-md-offset-4" style="width: 1052px; padding-right: 0px; padding-left: 0px">
                    ...
                    <div class="login-panel panel panel-default"> 
                        ...
                        <div class="panel-body" style=" height: 50%; padding: 0px;">
                            
                            <div id="navMenu" style="margin-top: 1px;">
                                <ul>
                                    <li><a href="#"><button class="btn btn-info" style="width: 148px; height: 38px; padding-top: 0px; margin-top: -5px; background-color: #428BCA;"><i class="fa fa-home"></i>Home</button></a>
                                    </li>
                                </ul>
                                <ul>
                                ...
                                <ul>
                                    <li><a href="#"><button class="btn btn-info" style="width: 148px; height: 38px; padding-top: 0px; margin-top: -5px;"><i class="fa fa-user"></i><%=firstName%></button></a>
                                        ...
                                        <div class="row well" style="margin-top: 5%; width: 80%;margin-left: 10%;padding-bottom: 0;padding-top: 1%;">
                                            <div class="col-sm-4">
                                                <%if(degStatusId==1){%>
                                                <div class="alert alert-success">Degree Application---Open</div>
                                                <%} else{%>
                                                <div class="alert alert-danger">Degree Application---Closed</div>
                                                <%}%>
                                            </div>
                                            <div class="col-sm-4">
                                                <%if(dipStatusId==1){%>
                                                <div class="alert alert-success">Diploma Application---Open</div>
                                                <%} else{%> 
                                                <div class="alert alert-danger">Diploma Application---Closed</div>
                                                <%}%>
                                            </div>
                                            <div class="col-sm-4">
                                                <%if(certStatusId==1){%>
                                                <div class="alert alert-success">Certificate Application---Open</div>
                                                <%} else{%>
                                                <div class="alert alert-danger">Certificate Application---Closed</div>
                                                <%}%> 
                                            </div>
                                        </div>
