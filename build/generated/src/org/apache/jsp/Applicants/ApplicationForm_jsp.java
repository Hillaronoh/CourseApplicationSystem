...
public final class ApplicationForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\n");
      out.write("                                                <a class=\"accordion-section-title alert alert-error\" style=\"margin-bottom:0px;\" href=\"#accordion-2\"><i class=\"fa fa-exclamation-triangle\"></i>There was an error saving your details..Please try again.</a>\n");
      out.write("                                                ");
}} else{
      out.write("\n");
...
while(results6.next()){
      ...
      out.print(results6.getString("course_Name"));
      out.write('"');
      out.write('>');
      out.print(results6.getString("course_Name"));
      out.write("</option>\n");
