<%-- 
    Document   : ViewCertApplicants.jsp
    Created on : Jul 27, 2015, 2:17:56 PM
    Author     : hillary
--%>
...
<html>
    <head>
        ...
        <title> Certificate Applicants </title>
           ...
           response.setHeader("Pragma","no-cache"); //HTTP 1.0 backward compatibility
            ...
            if(request.getParameter("post")!=null){
                ...
                <script type="text/javascript">
                    ...
                    window.location.href="ViewCertApplicants.jsp";
                </script>
                <%} else{%>
                <script type="text/javascript">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="cert-it">
                                            ...
                                            <tbody>
                                                ...
                                                <%if(request.getParameter("delete"+check)!=null){
                                                    int delCertIt=admin.deleteApplicant(email, levelId, courseId);
                                                    if(delCertIt>0){%>
                                                    <script>
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="cert-cf">
                                            ...
                                            <tbody>
                                                ...
                                                <%if(request.getParameter("delete"+check)!=null){
                                                    int delCertCf=admin.deleteApplicant(email, levelId, courseId);
                                                    if(delCertCf>0){%>
                                                    <script>
                                                        alert("Deleted Successfully.");
                                                        window.location.href="ViewCertApplicants.jsp";
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="cert-is">
                                            ...
                                            <tbody>
                                                ...
                                                <%if(request.getParameter("delete"+check)!=null){
                                                    int delCertIs=admin.deleteApplicant(email, levelId, courseId);
                                                    if(delCertIs>0){%>
                                                    <script>
                                                        alert("Deleted Successfully.");
                                                        window.location.href="ViewCertApplicants.jsp";
                                        ...
                                        <table class="table table-striped table-bordered table-hover" id="cert-hm">
                                            ...
                                            <tbody>
                                                ...
                                                <%if(request.getParameter("delete"+check)!=null){
                                                    int delCertHm=admin.deleteApplicant(email, levelId, courseId);
                                                    if(delCertHm>0){%> 
                                                    <script>
                                                        alert("Deleted Successfully.");
                                                        window.location.href="ViewCertApplicants.jsp";
